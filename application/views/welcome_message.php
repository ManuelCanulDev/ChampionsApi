...
<body id="page-top">
	...
	<section class="page-section portfolio mt-5" id="portfolio">
		<div class="container">
		<a class="btn btn-success" href="<?php echo base_url('Welcome/addChampion'); ?>" role="button">Agregar <i class="fas fa-plus fa-fw"></i></a>
		...
		$.ajax({
			...
			success: function (data) {
				...
				for (i = 0; i < data.data.length; i++) {
					...
					html += '</p>';
					html +=
						'<button class="btn btn-warning" href="#!" data-bs-dismiss="modal"> <i class="fas fa-pen fa-fw"></i></button> <a class="btn btn-danger" href="#" role="button"><i class="fas fa-trash fa-fw"></i></a> <a class="btn btn-info" href="<?php echo base_url('Welcome/verChampion/'); ?>' + data.data[i].id +'" role="button"><i class="fas fa-eye fa-fw"></i></a>';
